...
router.get('/stage', function(req, res, next){
	res.render("nonogram/game-screen", {title:"Welcome to Nonologic!"});
})

router.get('/editor', function(req,res,next){
	res.render("nonogram/editor", {title:"Welcome to Editor!"});
});

router.get("/queue/", function(req,res,next){
	res.render("nonogram/queue-screen", {title:"콘솔 시스템에 접근중입니다..."});
})

router.get('/test',function(req,res,next){
	res.render("nonogram/blank");
})
